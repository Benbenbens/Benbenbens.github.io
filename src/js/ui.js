...
function toggleLoading(isLoading) {
  ...
  if (isLoading === true){
    //var halfIcon = document.createElement("i");
    var halfIcon = document.querySelector("#search-btn");
    halfIcon.innerHTML = "Loading...";
    halfIcon.className = "fas fa-hourglass-half";
    halfIcon.disabled = true;
  }
